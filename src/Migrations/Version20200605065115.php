 ...
 */
final class Version20200605065115 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE booking_guests (booking_id INT NOT NULL, guests_id INT NOT NULL, INDEX IDX_F68B874C825B2E45 (guests_id), INDEX IDX_F68B874C3301C60 (booking_id), PRIMARY KEY(booking_id, guests_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
